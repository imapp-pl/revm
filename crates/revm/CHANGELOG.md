...
## [15.0.0](https://github.com/imapp-pl/revm/compare/revm-v14.0.1...revm-v15.0.0) - 2024-09-13
...
- *(inspector)* always call selfdestruct if entry is made ([#1746](https://github.com/imapp-pl/revm/pull/1746))

### Other

- *(deps)* bump alloy-sol-types from 0.8.0 to 0.8.2 ([#1762](https://github.com/imapp-pl/revm/pull/1762))
- *(deps)* bump anyhow from 1.0.86 to 1.0.87 ([#1760](https://github.com/imapp-pl/revm/pull/1760))
- make clippy happy ([#1755](https://github.com/imapp-pl/revm/pull/1755))
- Test l1 gas used fjord ([#1749](https://github.com/imapp-pl/revm/pull/1749))
- Add test for `revm::optimism::L1BlockInfo::calculate_tx_l1_cost_fjord` ([#1743](https://github.com/imapp-pl/revm/pull/1743))
- *(deps)* bump tokio from 1.39.2 to 1.40.0 ([#1739](https://github.com/imapp-pl/revm/pull/1739))
